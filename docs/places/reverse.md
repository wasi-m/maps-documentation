...
With reverse geocoding with Places, you can look up all sorts of information about points on a map, including:
...
Like other queries with Places, reverse geocoding has optional, additional parameters you can use to refine results.
...
By default, reverse geocoding returns results from any [data source](data-sources.md) available to Places. To filter results by source, specify one or more valid source names in a comma-delimited list using the `sources` parameter. For example, the following request returns only results from OpenStreetMap:
...
[/v1/reverse?point.lat=51.5081124&point.lon=-0.0759493](/v1/reverse%3Fpoint.lat=51.5081124&point.lon=-0.0759493)

### Only OpenStreetMap results near the Tower of London
[/v1/reverse?point.lat=51.5081124&point.lon=-0.0759493&sources=osm](/v1/reverse%3Fpoint.lat=51.5081124&point.lon=-0.0759493&sources=osm)

### Only street addresses near the Tower of London
[/v1/reverse?point.lat=51.5081124&point.lon=-0.0759493&layers=address](/v1/reverse%3Fpoint.lat=51.5081124&point.lon=-0.0759493&layers=address)

### Only OpenStreetMap street addresses near the Tower of London
[/v1/reverse?point.lat=51.5081124&point.lon=-0.0759493&layers=address&sources=osm](/v1/reverse%3Fpoint.lat=51.5081124&point.lon=-0.0759493&layers=address&sources=osm)

### Only the first OpenStreetMap address near the Tower of London
[/v1/reverse?point.lat=51.5081124&point.lon=-0.0759493&layers=address&sources=osm&size=1](/v1/reverse%3Fpoint.lat=51.5081124&point.lon=-0.0759493&layers=address&sources=osm&size=1)
