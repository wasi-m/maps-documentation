...
Directions API draws data from OpenStreetMap for the major part of the routing graph and can optionally include elevation data from the TileZen project hosted on the [AWS Open Data](https://registry.opendata.aws/terrain-tiles/) platform, user-provided GTFS feeds, reproducible timezone data, custom historical traffic data.
